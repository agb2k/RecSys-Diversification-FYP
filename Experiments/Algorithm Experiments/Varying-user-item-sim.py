...
sim_item = {'name': 'MSD',
            'user_based': 'False'}
knnon2Algo = KNNOFN(sim_options=sim_item)
knnon2Algo.fit(trainSet)
algoList.append(knnon2Algo)
algoNameList.append('Item Based')

sim_user = {'name': 'MSD',
            'user_based': 'True'}
knnon3Algo = KNNOFN(sim_options=sim_user)
knnon3Algo.fit(trainSet)
algoList.append(knnon3Algo)
algoNameList.append('user Based')
...
df.to_csv('../../Output/Algorithm-Experiments-Output/Comparison-user-item.csv')
